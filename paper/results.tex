...
\begin{table}[h]
    \centering
    \caption{Few-Shot Classification Accuracy (16-shot) on three benchmarks. DAPT consistently outperforms baselines.}
    \label{tab:main_results}
    \begin{tabular}{lccc}
        \toprule
        Method & MVTec AD & EuroSAT & Oxford Pets \\
        \midrule
        Zero-Shot CLIP & 62.1$\pm$0.5 & 35.4$\pm$1.1 & 81.2$\pm$0.3 \\
        CoOp & 78.4$\pm$1.2 & 72.1$\pm$1.5 & 85.5$\pm$0.6 \\
        Tip-Adapter-F & 81.3$\pm$0.8 & 76.8$\pm$0.9 & 87.1$\pm$0.4 \\
        \textbf{DAPT (Ours)} & \textbf{85.4$\pm$0.6} & \textbf{80.2$\pm$0.7} & \textbf{88.3$\pm$0.3} \\
        \bottomrule
    \end{tabular}
\end{table}
