...
We report average accuracy over 5 independent seeds to ensure statistical significance.
We follow the standard episodic protocol with $K=16$ shot support and 15 query samples per class.
$\alpha$ was selected via validation on a held-out support split and fixed across all datasets.
