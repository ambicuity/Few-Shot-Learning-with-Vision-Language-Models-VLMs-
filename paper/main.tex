...
Experiments on MVTec AD, EuroSAT, and Oxford Pets demonstrate that DAPT outperforms state-of-the-art baselines by up to 4.1\%, establishing a new benchmark for robust, label-agnostic few-shot learning.
\end{abstract}
