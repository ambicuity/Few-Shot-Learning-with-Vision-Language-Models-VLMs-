...
Vision-Language Models (VLMs) like CLIP have revolutionized few-shot learning by leveraging massive pre-training. 
Early approaches such as CoOp introduced learnable context vectors to replace hand-crafted prompts, significantly improving adaptation performance. 
...
Efficiency remains a core challenge. While adapter-based methods like Tip-Adapter cached visual features for few-shot inference, they often lack the semantic flexibility of prompt tuning.
